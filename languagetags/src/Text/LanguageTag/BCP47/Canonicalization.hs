...
-- canonicalize 'BCP47Tag' values according to the relevant section of
...
-- | Canonicalize a 'BCP47Tag'. Since the variant subtags and
-- extensions of a 'BCP47Tag' are already sorted, this function only
...
canonicalizeBCP47 :: BCP47Tag -> BCP47Tag
