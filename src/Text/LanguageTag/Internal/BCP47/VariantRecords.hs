...
variantTable =
  [(Var1606nict, Subtag 7122868793502725176, VariantRecord ("Late Middle French (to 1606)" :| []) NotDeprecated [NormalTag $ Normal Frm Nothing Nothing Nothing (S.fromList []) M.empty []])
  ,(Var1694acad, Subtag 7122947813896414264, VariantRecord ("Early Modern French" :| []) NotDeprecated [NormalTag $ Normal Fr Nothing Nothing Nothing (S.fromList []) M.empty []])
  ...
  ,(Var1959acad, Subtag 7126290672842236984, VariantRecord ("\"Academic\" (\"governmental\") variant of Belarusian as\ncodified in 1959" :| []) NotDeprecated [NormalTag $ Normal Be Nothing Nothing Nothing (S.fromList []) M.empty []])
  ...
  ,(Alalc97, Subtag 14101631129414762551, VariantRecord ("ALA-LC Romanization, 1997 edition" :| []) NotDeprecated [])
  ...
  ,(Luna1918, Subtag 15697144863862077496, VariantRecord ("Post-1917 Russian orthography" :| []) NotDeprecated [NormalTag $ Normal Ru Nothing Nothing Nothing (S.fromList []) M.empty []])
  ...
  ,(Pahawh2, Subtag 16251034879248629815, VariantRecord ("Pahawh Hmong Second Stage Reduced orthography" :| []) NotDeprecated [NormalTag $ Normal Mww Nothing Nothing Nothing (S.fromList []) M.empty [],NormalTag $ Normal Hnj Nothing Nothing Nothing (S.fromList []) M.empty []])
  ,(Pahawh3, Subtag 16251034879248662583, VariantRecord ("Pahawh Hmong Third Stage Reduced orthography" :| []) NotDeprecated [NormalTag $ Normal Mww Nothing Nothing Nothing (S.fromList []) M.empty [],NormalTag $ Normal Hnj Nothing Nothing Nothing (S.fromList []) M.empty []])
  ,(Pahawh4, Subtag 16251034879248695351, VariantRecord ("Pahawh Hmong Final Version orthography" :| []) NotDeprecated [NormalTag $ Normal Mww Nothing Nothing Nothing (S.fromList []) M.empty [],NormalTag $ Normal Hnj Nothing Nothing Nothing (S.fromList []) M.empty []])
  ...
  ,(Petr1708, Subtag 16255645162436835384, VariantRecord ("Petrine orthography" :| []) NotDeprecated [NormalTag $ Normal Ru Nothing Nothing Nothing (S.fromList []) M.empty []])
