...
module LanguageTag.BCP47.Registry.ExtlangSpec (spec) where
...
import LanguageTag.BCP47.Validation (validateExtlang)
import LanguageTag.Internal.BCP47.Registry.ExtlangRecords (extlangDetails)
