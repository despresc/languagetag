...
module LanguageTag.BCP47.Registry.RedundantSpec (spec) where
...
import LanguageTag.BCP47.Canonicalization (lintBCP47)
...
import LanguageTag.Internal.BCP47.Registry.RedundantRecords (redundantDetails)
