...
module LanguageTag.BCP47.Registry.RegionSpec (spec) where
...
import LanguageTag.BCP47.Validation (validateRegion)
import LanguageTag.Internal.BCP47.Registry.RegionRecords (regionDetails)
