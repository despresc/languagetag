...
module LanguageTag.BCP47.RegistrySpec (spec) where
...
import LanguageTag.BCP47.Registry.Redundant (recognizeRedundantTag, redundantTrie)
import LanguageTag.BCP47.Subtag (parseSubtagText, renderSubtagLower)
import qualified LanguageTag.BCP47.Subtag.Trie as Trie
import qualified LanguageTag.BCP47.Syntax as Syn
import LanguageTag.BCP47.Validation
  ( validateBCP47,
    validateExtlang,
    validateLanguage,
    validateRegion,
...
import LanguageTag.Internal.BCP47.Registry.Types (unsafeBinSearchIndexOn)
import qualified LanguageTag.Internal.BCP47.Syntax as SynI
