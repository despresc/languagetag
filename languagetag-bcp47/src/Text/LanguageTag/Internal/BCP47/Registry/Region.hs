...
-- | The BCP47 region subtags as of 2021-07-21. The names of region constructors come from the corresponding subtag, except that subtags beginning with a number are prefixed with @Reg@.
data Region
