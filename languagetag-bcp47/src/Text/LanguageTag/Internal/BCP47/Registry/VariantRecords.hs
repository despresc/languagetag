...
variantDetails = V.fromList
  ...
  ,(Subtag 15674689155847192583, VariantRecord ("Classical Sanskrit" :| []) NotDeprecated [Normal Sa Nothing Nothing Nothing (S.fromList []) M.empty []])
  ...
  ,(Subtag 17115735002453147655, VariantRecord ("Vedic Sanskrit" :| []) NotDeprecated [Normal Sa Nothing Nothing Nothing (S.fromList []) M.empty []])
