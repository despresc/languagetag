...
-- | The BCP47 region subtags as of 2023-10-16. The names of region constructors come from the corresponding subtag, except that subtags beginning with a number are prefixed with @Reg@.
data Region
