...
module LanguageTag.BCP47.Canonicalization
  ( -- * General linting
    lintBCP47,
    LintWarnings (..),
    DeprecatedComponent (..),
...
import LanguageTag.BCP47.Registry.Region (lookupRegionRecord)
import LanguageTag.BCP47.Registry.Script (lookupScriptRecord)
import LanguageTag.BCP47.Registry.Variant (lookupVariantRecord)
import LanguageTag.Internal.BCP47.Registry.Extlang (Extlang)
...
import LanguageTag.Internal.BCP47.Registry.Variant (Variant)
...
--
-- @
-- 'PrefixCollision' ('LanguageTag.BCP47.Registry.Variant.Var1901' ':|' []) (('LanguageTag.BCP47.Registry.Variant.Var1996' ':|' []) ':|' [])
-- @
...
-- @
-- 'VariantChains'
--   [('LanguageTag.BCP47.Registry.Variant.Rozaj',
--     'VariantChains'
--       [('LanguageTag.BCP47.Registry.Variant.Biske', 'VariantChains' [('LanguageTag.BCP47.Registry.Variant.Var1994', 'VariantChains' [])]),
--        ('LanguageTag.BCP47.Registry.Variant.Njiva', 'VariantChains' [('LanguageTag.BCP47.Registry.Variant.Var1994', 'VariantChains' [])])
--       ])]
-- @
...
-- 'LanguageTag.BCP47.Registry.renderBCP47' and
-- 'LanguageTag.BCP47.Registry.toSubtags'.
--
